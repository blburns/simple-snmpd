...
struct AccessControlEntry {
  ...
  AccessControlEntry(const std::string &comm, const std::string &ip,
                     bool ro = true)
...
struct RateLimitEntry {
  ...
  RateLimitEntry()
      : request_count(0), max_requests(100),
...
public:
  ...
  // Access control
  bool is_access_allowed(const std::string &community,
                         const std::string &source_ip) const;
  bool is_oid_allowed(const std::string &community,
  ...
  void remove_access_control_entry(const std::string &community,
                                   const std::string &source_ip);
  void set_rate_limit(const std::string &source_ip, uint32_t max_requests,
                      std::chrono::seconds window);
  void set_default_rate_limit(uint32_t max_requests,
                              std::chrono::seconds window);
...
private:
  ...
  bool is_ip_in_list(const std::string &ip,
                     const std::set<std::string> &ip_list) const;
  bool is_ip_in_subnet_list(const std::string &ip,
                            const std::set<std::string> &subnet_list) const;
};
