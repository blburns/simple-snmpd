...
void test_mib_manager_scalar() {
  ...
  std::vector<uint8_t> sys_descr_oid = {0x2b, 0x06, 0x01, 0x02,
                                        0x01, 0x01, 0x01, 0x00};
  MIBValue value;
...
void test_mib_manager_table() {
  ...
  std::vector<uint8_t> if_index_oid = {0x2b, 0x06, 0x01, 0x02, 0x01,
                                       0x02, 0x02, 0x01, 0x01};
  ...
  std::vector<uint8_t> if_index_entry_oid = {0x2b, 0x06, 0x01, 0x02, 0x01,
...
void test_mib_manager_standard_mibs() {
  ...
  // Test Interface MIB
  std::vector<uint8_t> if_number_oid = {0x2b, 0x06, 0x01, 0x02,
                                        0x01, 0x02, 0x01, 0x00};
  ...
  // Test SNMP MIB
  std::vector<uint8_t> snmp_in_pkts_oid = {0x2b, 0x06, 0x01, 0x02,
                                           0x01, 0x0b, 0x01, 0x00};
