...
SNMPConnection::SNMPConnection(int socket_fd, const std::string& client_address, uint16_t client_port)
...
uint16_t SNMPConnection::get_client_port() const {
    return client_port_;
}

std::chrono::steady_clock::time_point SNMPConnection::get_last_activity() const {
...
int SNMPConnection::get_socket_fd() const {
    return socket_fd_;
}
